...
def add_cafe():
    ...
    if form.validate_on_submit():
        ...
        with open('cafe-data.csv', 'a',  encoding='utf-8', newline='') as csvfile:
            ...
            writer.writerow({'Cafe Name': form.cafe.data, 'Location': form.location_URL.data, 'Open': form.open_time.data, 'Close': form.close_time.data, 'Coffee': form.coffee_rating.data, 'Wifi': form.wifi_rating.data, 'Power': form.power_rating.data})
